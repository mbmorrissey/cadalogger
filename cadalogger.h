...
#define CADALOGGERMINI_RTC_INT_PIN 22
#define CADALOGGERMINI_SD_SS_PIN 11
#define CADALOGGERMINI_SD_SCL_PIN 10
#define CADALOGGERMINI_SD_MOSI_PIN 8
#define CADALOGGERMINI_SD_MISO_PIN 9
